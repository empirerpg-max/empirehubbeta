...
import { ChevronLeft, Info, HelpCircle, BookOpen, Music, ShoppingBag, TrendingUp, Trophy } from "lucide-react";
  ...
  return (
    <main className="flex-1 mx-auto w-full max-w-2xl px-4 pt-6 pb-20">
      ...
      <header className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">Aprenda a dominar o mundo artístico no Artistic Oasis.</p>
      </header>
      ...
      <div className="space-y-8">
        ...
        <div className="p-6 rounded-2xl bg-card border border-border">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Fique atento à <strong>Fadiga</strong> do seu artista. Tours intensas aumentam a fadiga, o que pode prejudicar o desempenho. Use os itens de 'Férias' no mercado para descansar.
          </p>
        </div>
      </div>
      ...
      <div className="mt-12 p-8 rounded-3xl bg-secondary text-center">
        ...
        <p className="text-sm text-muted-foreground mb-6">Explore os menus e comece sua jornada ao topo!</p>
        <Link to="/" className="inline-flex py-3 px-8 rounded-full bg-primary text-primary-foreground font-bold shadow-lg shadow-primary/20">
          Vamos lá!
        </Link>
      </div>
    </main>
...
function TutorialSection({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
